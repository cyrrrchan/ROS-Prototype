...
public class PlayerControl : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
        ...
        if (_isCrouching && !_noMoving)
        {
            anim.SetBool("Crouch", true);
        }

        else if (!_isCrouching && !_noMoving)
        {
